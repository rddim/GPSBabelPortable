...
user in an INI file next to GPSBabelPortable.exe called GPSBabelPortable.ini.
...
copy AppNamePortable.ini from this directory to GPSBabelPortable.ini next to
GPSBabelPortable.exe. The options in the INI file are as follows:
